...
<head>
    ...
    <title>Produk - TE-Store Admin</title>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                // ambil data tb_jual
                                $jual = mysqli_fetch_assoc(mysqli_query(
                                    $koneksi,
                                    "SELECT * FROM tb_jual tj JOIN tb_user tu ON tj.id_user = tu.id_user WHERE tj.id_jual = '$id_jual'"
                                ));

                                // ambil data detail jual
                                $detail = mysqli_query($koneksi, "SELECT tjd.id_produk, tjd.qty, tjd.harga 
                                AS subtotal, tp.nm_produk, tp.harga AS harga_produk 
                                FROM tb_jualdtl tjd JOIN tb_produk tp ON tjd.id_produk = tp.id_produk WHERE tjd.id_jual = '$id_jual'");
                                ?>
