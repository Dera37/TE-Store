...
if (isset($_GET['id'])) {
    ...
    //Ambil data produk bedasarkan ID
...
if (isset($_POST['update'])) {
    ...
    if ($_FILES['gamba']['name'] != "") {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            if (file_exists($dir . $gamabr_lama) && $gamabr_lama != "") {
                unlink($dir . $gamabr_lama);
            }
        ...
        $imgnewfile = $gamabr_lama; //Jika tidak ada gambar baru, gunakan gambar lama
    }
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3 mt-2" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-12">
                                    ...
                                    placeholder="Masukkan Nama Produk" value="<?php echo $data['nm_produk']; ?>" required>
                                </div>
                                <div class="col-12">
                                    <label for="harga" class="form-label">Harga</label>
                                    <input type="number" class="form-control" id="harga" name="harga" 
                                    placeholder="Masukkan Harga Produk" value="<?php echo $data['harga']; ?>" required>
                                </div>
                                <div class="col-12">
