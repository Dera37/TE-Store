...
<head>
    ...
    <title>Keranjang - TE-Store Admin</title>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        //Tahap filter kategori dari GET
                        $filter_kategori = isset($_GET['kategori']) ? $_GET['kategori'] : '';
                        ?>

                        <div class="fiter-bar mt-3">
                            <form class="filter-form d-flex align-items-center" method="GET" action="">
                                <select name="kategori" class="form-select me-2" style="max-width: 200px;" title="Pilih Kategori" id="">
