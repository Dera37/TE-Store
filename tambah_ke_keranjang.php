...
if (!isset($_SESSION['id_user'])) {
    die ("<script>alert('Anda belum logon'); window.location.href='login.php';</script>");
}
...
if ($data && $data['stok'] >= $jumlah) {
    ...
    if ($insert) {
        ...
        echo "<script>alert('Gagal menyimpan pesan'); window.location.href='$redirect';</script>";
    }
} else {
