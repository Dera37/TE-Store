                        ...
                        <div class="col-12">
                            ...
                            if (isset($_POST['cheackout'])) {
                                ...
                                while ($row = mysqli_fetch_assoc($query_pesanan)) {
                                    ...
                                    // Generate id_penjual otomatis (format T001, T002, dst)
                                    $result = mysqli_query($koneksi, "SELECT MAX(RIGHT(id_penjual, 3)) AS max_id FROM tb_jual");
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            if (!isset($_SESSION['username'])) {
                                                echo "<tr><td colspan='6'>Silahkan login terlebih dahulu.</td></tr>";
                                                exit;
                                            }
